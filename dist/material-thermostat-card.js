...
`,St={off:"mdi:power",heat:"mdi:fire",cool:"mdi:snowflake",heat_cool:"mdi:sun-snowflake-variant",auto:"mdi:thermostat-auto",dry:"mdi:water-percent",fan_only:"mdi:fan"};function Ct(t){switch(t){case"cool":return"var(--state-climate-cool-color, #2b9af9)";case"heat":return"var(--state-climate-heat-color, #ff8100)";case"heat_cool":return"var(--state-climate-heat_cool-color, #009688)";case"auto":return"var(--state-climate-auto-color, #e5c454)";case"dry":return"var(--state-climate-dry-color, #efbd07)";case"fan_only":return"var(--state-climate-fan_only-color, #8a8a8a)";default:return"var(--state-climate-off-color, var(--mt-on-surface-variant))"}}function Et(t){return"heat_cool"===t?"Heat/Cool":t.replace(/_/g," ").replace(/\b\w/g,t=>t.toUpperCase())}const Ot=_t(class extends yt{constructor(t){if(super(t),1!==t.type||"class"!==t.name||t.strings?.length>2)throw Error("`classMap()` can only be used in the `class` attribute and must be the only part in the attribute.")}render(t){return" "+Object.keys(t).filter(e=>t[e]).join(" ")+" "}update(t,[e]){if(void 0===this.st){this.st=new Set,void 0!==t.strings&&(this.nt=new Set(t.strings.join(" ").split(/\s/).filter(t=>""!==t)));for(const t in e)e[t]&&!this.nt?.has(t)&&this.st.add(t);return this.render(e)}const i=t.element.classList;for(const t of this.st)t in e||(i.remove(t),this.st.delete(t));for(const t in e){const s=!!e[t];s===this.st.has(t)||this.nt?.has(t)||(s?(i.add(t),this.st.add(t)):(i.remove(t),this.st.delete(t)))}return q}});try{CSS.registerProperty?.({name:"--dial-color",syntax:"<color>",inherits:!0,initialValue:"transparent"})}catch{}const Mt=["cool","heat","heat_cool","auto","dry","fan_only"],zt=160,Pt=225,Ht=270;function It(t,e){const i=(t-90)*Math.PI/180;return{x:zt+e*Math.cos(i),y:zt+e*Math.sin(i)}}let Tt=class extends nt{constructor(){super(...arguments),this.value=20,this.min=7,this.max=35,this.step=.5,this.mode="off",this.modeLabel="",this.unit="°C",this.showCurrentAsPrimary=!1,this.disabled=!1,this.dual=!1,this._dragging=!1,this._dragValue=0,this._dragLow=0,this._dragHigh=0,this._activeHandle=null,this._onPointerDown=t=>{if(this.disabled||!this._isRingHit(t.clientX,t.clientY))return;t.preventDefault(),this._svg.setPointerCapture(t.pointerId),this._dragging=!0;const e=this._valueFromPoint(t.clientX,t.clientY);this.dual&&(this._dragLow=this._displayLow,this._dragHigh=this._displayHigh,this._activeHandle=Math.abs(e-this._dragLow)<=Math.abs(e-this._dragHigh)?"low":"high"),this._emitFromValue(e)},this._onPointerMove=t=>{this._dragging&&this._emitFromValue(this._valueFromPoint(t.clientX,t.clientY))},this._onPointerUp=t=>{this._dragging&&(this._svg.releasePointerCapture(t.pointerId),this._dragging=!1,this.dual?(this._emit("value-changed",{low:this._dragLow,high:this._dragHigh}),this._activeHandle=null):this._emit("value-changed",{value:this._dragValue}))},this._onKeyDown=t=>{if(this.disabled||this.dual)return;let e;"ArrowUp"===t.key||"ArrowRight"===t.key?e=this.value+this.step:"ArrowDown"!==t.key&&"ArrowLeft"!==t.key||(e=this.value-this.step),void 0!==e&&(t.preventDefault(),this._emit("value-changed",{value:this._roundToStep(e)}))}}get _precision(){return this.step<1?1:0}get _displayValue(){return this._dragging?this._dragValue:this.value}get _displayLow(){return this._dragging?this._dragLow:this.lowValue??this.min}get _displayHigh(){return this._dragging?this._dragHigh:this.highValue??this.max}_angleOf(t){const e=(t-this.min)/(this.max-this.min||1);return Pt+Math.min(1,Math.max(0,e))*Ht}_fracOf(t){return(this._angleOf(t)-Pt)/Ht}_roundToStep(t){const e=Math.min(this.max,Math.max(this.min,t)),i=Math.round(e/this.step)*this.step;return parseFloat(i.toFixed(this._precision))}_isRingHit(t,e){const i=this._svg.getBoundingClientRect(),s=i.width/320||1,a=t-(i.left+i.width/2),r=e-(i.top+i.height/2),o=Math.hypot(a,r)/s;if(o<98||o>152)return!1;let n=180*Math.atan2(r,a)/Math.PI+90;return n=(n%360+360)%360,n>=Pt||n<=135}_valueFromPoint(t,e){const i=this._svg.getBoundingClientRect(),s=i.left+i.width/2,a=i.top+i.height/2;let r,o=180*Math.atan2(e-a,t-s)/Math.PI+90;o=(o%360+360)%360,r=o>=Pt?o-Pt:o<=135?o+360-Pt:o<180?Ht:0;const n=Math.min(1,Math.max(0,r/Ht));return this._roundToStep(this.min+n*(this.max-this.min))}_applyDual(t){"low"===this._activeHandle?this._dragLow=Math.min(t,this._dragHigh-this.step):this._dragHigh=Math.max(t,this._dragLow+this.step)}_emitFromValue(t){this.dual?(this._applyDual(t),this._emit("value-changing",{low:this._dragLow,high:this._dragHigh})):(this._dragValue=t,this._emit("value-changing",{value:t}))}_step(t){this.disabled||this._emit("value-changed",{value:this._roundToStep(this.value+t*this.step)})}_emit(t,e){this.dispatchEvent(new CustomEvent(t,{detail:e,bubbles:!0,composed:!0}))}_fmt(t,e){return null==t||Number.isNaN(t)?"—":t.toFixed(e)}_fmtCompact(t){return Number.isInteger(t)?String(t):t.toFixed(1)}_dotOrbit(t,e){return V`<div class="orbit" style=${`transform: rotate(${t}deg)`}>
    ...
    </div>`}render(){const t=!Mt.includes(this.mode),e=t?"var(--mt-on-surface-variant)":Ct(this.mode),i=St[this.mode]??"mdi:thermostat",s=null!=this.current&&this.current>=this.min&&this.current<=this.max,a=this._angleOf(this._displayValue),r=s?this._angleOf(this.current):0,o=!this.dual&&s&&!t&&Math.abs(a-r)<18;let n=0,l=0,c=!1;this.dual?(n=this._fracOf(this._displayLow),l=this._fracOf(this._displayHigh),c=!0):s&&!t&&(n=Math.min(this._fracOf(this._displayValue),this._fracOf(this.current)),l=Math.max(this._fracOf(this._displayValue),this._fracOf(this.current)),c=!0);const d=function(t,e,i){const s=It(225,i),a=It(495,i);return`M ${s.x} ${s.y} A 130 130 0 1 1 ${a.x} ${a.y}`}(0,0,130),h=`${(1e3*(l-n)).toFixed(2)} 1000`,p=(1e3*-n).toFixed(2),u=V`<span class="num current">${this._fmtCompact(this.current)}°</span>`,m=V`<ha-icon class="mode-icon" icon=${i}></ha-icon>`;return V`
      <div
      ...
      >
        ...
        <div class="markers">
          ${this.dual?V`
                ...
                ${s?this._labelOrbit(r,u):B}
              `:V`
                ${this._dotOrbit(a,"setpoint")}
                ${s?this._dotOrbit(r,"current"):B}
                ${o?this._labelOrbit(r,V`<span class="num current with-icon"
    ...
    `],t([pt({type:Number})],Tt.prototype,"value",void 0),t([pt({type:Number})],Tt.prototype,"min",void 0),t([pt({type:Number})],Tt.prototype,"max",void 0),t([pt({type:Number})],Tt.prototype,"step",void 0),t([pt({type:Number})],Tt.prototype,"current",void 0),t([pt()],Tt.prototype,"mode",void 0),t([pt()],Tt.prototype,"modeLabel",void 0),t([pt()],Tt.prototype,"unit",void 0),t([pt({type:Boolean})],Tt.prototype,"showCurrentAsPrimary",void 0),t([pt({type:Boolean})],Tt.prototype,"disabled",void 0),t([pt({type:Boolean})],Tt.prototype,"dual",void 0),t([pt({type:Number})],Tt.prototype,"lowValue",void 0),t([pt({type:Number})],Tt.prototype,"highValue",void 0),t([ut()],Tt.prototype,"_dragging",void 0),t([ut()],Tt.prototype,"_dragValue",void 0),t([ut()],Tt.prototype,"_dragLow",void 0),t([ut()],Tt.prototype,"_dragHigh",void 0),t([ut()],Tt.prototype,"_activeHandle",void 0),t([(t,e,i)=>((t,e,i)=>(i.configurable=!0,i.enumerable=!0,Reflect.decorate&&"object"!=typeof e&&Object.defineProperty(t,e,i),i))(t,e,{get(){return t=this,t.renderRoot?.querySelector("svg")??null;var t}})],Tt.prototype,"_svg",void 0),Tt=t([ct("mt-circular-dial")],Tt);let Lt=class extends nt{constructor(){super(...arguments),this.items=[],this.placeholder="",this._open=!1,this._up=!1,this._onDocClick=t=>{this._open&&!t.composedPath().includes(this)&&(this._open=!1)}}connectedCallback(){super.connectedCallback(),document.addEventListener("click",this._onDocClick)}disconnectedCallback(){super.disconnectedCallback(),document.removeEventListener("click",this._onDocClick)}get _active(){return this.items.find(t=>t.active)??this.items[0]}_toggle(t){if(t.stopPropagation(),!this._open){const t=this.getBoundingClientRect();this._up=t.bottom>.55*window.innerHeight}this._open=!this._open}_select(t,e){t.stopPropagation(),this._open=!1,this.dispatchEvent(new CustomEvent("item-selected",{detail:{value:e}}))}render(){const t=this._active;return V`
      ...
      ${this._open?V`<div class=${Ot({menu:!0,up:this._up})} role="listbox">
    ...
    `],t([pt({attribute:!1})],Lt.prototype,"items",void 0),t([pt()],Lt.prototype,"placeholder",void 0),t([ut()],Lt.prototype,"_open",void 0),t([ut()],Lt.prototype,"_up",void 0),Lt=t([ct("mt-dropdown")],Lt);let Ut=class extends nt{constructor(){super(...arguments),this.items=[],this.display="icons"}_select(t){this.dispatchEvent(new CustomEvent("item-selected",{detail:{value:t},bubbles:!0,composed:!0}))}render(){return this.items.length?"dropdown"===this.display?this._renderDropdown():this._renderIcons():B}_renderIcons(){return V`
      <div class="row">
    ...
    `],t([pt({attribute:!1})],Bt.prototype,"hass",void 0),t([pt({attribute:!1})],Bt.prototype,"config",void 0),Bt=t([ct("mt-entity-tile")],Bt);let Wt=class extends nt{willUpdate(t){if(!t.has("feature")||!this.feature)return;const e=this.feature;"entity-tile"===e.type?(this.style.flex="1 1 "+(e.compact?"76px":"150px"),this.style.maxWidth=e.width?`${e.width}px`:e.compact?"120px":"none"):(this.style.flex="1 1 100%",this.style.maxWidth="none")}render(){const t=this.feature;switch(t.type){case"climate-hvac-modes":case"climate-fan-modes":case"climate-swing-modes":{const e="climate-hvac-modes"===t.type?"hvac":"climate-fan-modes"===t.type?"fan":"swing";return V`<mt-climate-selector
          .hass=${this.hass}
  ...
  `,t([pt({attribute:!1})],Wt.prototype,"hass",void 0),t([pt()],Wt.prototype,"entityId",void 0),t([pt({attribute:!1})],Wt.prototype,"feature",void 0),Wt=t([ct("mt-feature-row")],Wt),console.info("%c MATERIAL-THERMOSTAT-CARD %c v0.3.0 ","color: white; background: #6750a4; font-weight: 700;","color: #6750a4; background: white; font-weight: 700;"),window.customCards=window.customCards||[],window.customCards.push({type:xt,name:"Material Thermostat Card",description:"A Material 3 Expressive thermostat card with customizable selectors and Nest/Google Home inspired UI.",preview:!0,documentationURL:"https://github.com/lageorgem/ha-material-thermostat-card"});let Kt=class extends nt{constructor(){super(...arguments),this._widthPx=0}static async getConfigElement(){return await Promise.resolve().then(function(){return oe}),document.createElement(kt)}static getStubConfig(t){const e=Object.keys(t.states).find(t=>t.startsWith("climate."))??"";return{type:`custom:${xt}`,entity:e,features:[{type:"climate-hvac-modes"}]}}setConfig(t){if(!t.entity||"climate"!==t.entity.split(".")[0])throw new Error("You must specify a climate entity.");this._config=t}getCardSize(){return 7+(this._config?.features?.length??0)}get _stateObj(){return this.hass?.states?.[this._config?.entity]}_trackedEntityIds(){const t=new Set([this._config.entity]);for(const e of this._config.features??[])"entity"in e&&e.entity&&t.add(e.entity),"entities"in e&&e.entities?.forEach(e=>t.add(e.entity)),"items"in e&&e.items?.forEach(e=>t.add(e.entity));return[...t]}shouldUpdate(t){if(t.has("_config")||t.has("_selectedTemp"))return!0;if(!this._config)return!1;if(t.has("hass")){const e=t.get("hass");return!e||this._trackedEntityIds().some(t=>e.states[t]!==this.hass.states[t])}return!1}updated(t){if(t.has("hass")||t.has("_config")){const e=t.get("hass");!this._config?.theme||e&&e.themes===this.hass.themes&&!t.has("_config")||function(t,e,i,s){void 0===s&&(s=!1),t._themes||(t._themes={});var a=e.default_theme;("default"===i||i&&e.themes[i])&&(a=i);var r=vt({},t._themes);if("default"!==a){var o=e.themes[a];Object.keys(o).forEach(function(e){var i="--"+e;t._themes[i]="",r[i]=o[e]})}if(t.updateStyles?t.updateStyles(r):window.ShadyCSS&&window.ShadyCSS.styleSubtree(t,r),s){var n=document.querySelector("meta[name=theme-color]");if(n){n.hasAttribute("default-content")||n.setAttribute("default-content",n.getAttribute("content"));var l=r["--primary-color"]||n.getAttribute("default-content");n.setAttribute("content",l)}}}(this,this.hass.themes,this._config.theme)}if(t.has("hass")){const t=this._stateObj?.attributes;null!=this._selectedTemp&&t?.temperature===this._selectedTemp&&(this._selectedTemp=void 0),null!=this._selectedLow&&t?.target_temp_low===this._selectedLow&&(this._selectedLow=void 0),null!=this._selectedHigh&&t?.target_temp_high===this._selectedHigh&&(this._selectedHigh=void 0)}}_observeWidth(){if(this._resizeObserver||"undefined"==typeof ResizeObserver)return;const t=this.shadowRoot?.querySelector("ha-card");t&&(this._resizeObserver=new ResizeObserver(t=>{const e=t[0]?.contentRect.width??0;Math.abs(e-this._widthPx)>=1&&(this._widthPx=e)}),this._resizeObserver.observe(t))}firstUpdated(){this._observeWidth()}connectedCallback(){super.connectedCallback(),this.hasUpdated&&this._observeWidth()}_visibleCount(t,e){if(!t?.length)return 0;if(!e?.length)return t.length;const i=new Set(e.filter(t=>t.hide).map(t=>t.value));return t.filter(t=>!i.has(t)).length}_featureUnits(t){const e=this._stateObj?.attributes;switch(t.type){case"climate-hvac-modes":return"dropdown"===t.display?4:this._visibleCount(e?.hvac_modes,t.options);case"climate-fan-modes":return"dropdown"===t.display?4:this._visibleCount(e?.fan_modes,t.options);case"climate-swing-modes":return"dropdown"===t.display?4:this._visibleCount(e?.swing_modes,t.options);case"input-select":return"dropdown"===t.display?4:this._visibleCount(this.hass.states[t.entity]?.attributes?.options,t.options);case"switch-group":return"dropdown"===t.display?4:t.entities?.length??0;case"switch-list":return t.entities?.length??0;case"button-list":return t.items?.length??0;case"entity-tile":return 6;default:return 0}}_maxFeatureUnits(){const t=this._config.features??[];return t.length?Math.max(1,...t.map(t=>this._featureUnits(t))):0}_layout(){const t=this._config.features??[],e=Math.min(18,Math.max(1,Math.floor(this._widthPx/48)));if(!(this._widthPx>0&&t.length>0&&e>=12))return{wide:!1,dialStyle:{},featureStyle:{}};let i=Math.min(this._maxFeatureUnits(),9),s=Math.max(6,i);for(;s+i>e&&i>1;)i-=1,s=Math.max(6,i);return{wide:!0,dialStyle:{flex:`0 0 ${48*s}px`,paddingInline:24*(s-6)+"px"},featureStyle:{flex:`0 0 ${48*i}px`}}}get _isDual(){const t=this._stateObj?.attributes;return"heat_cool"===this._stateObj?.state&&null!=t?.target_temp_low&&null!=t?.target_temp_high}get _targetTemp(){return this._selectedTemp??this._stateObj?.attributes.temperature}get _targetLow(){return this._selectedLow??this._stateObj?.attributes.target_temp_low}get _targetHigh(){return this._selectedHigh??this._stateObj?.attributes.target_temp_high}_scheduleCommit(){this._debounceTimer&&window.clearTimeout(this._debounceTimer),this._debounceTimer=window.setTimeout(()=>{const t={entity_id:this._config.entity};this._isDual?(t.target_temp_low=this._targetLow,t.target_temp_high=this._targetHigh):t.temperature=this._targetTemp,this.hass.callService("climate","set_temperature",t)},600)}_onChanging(t){const{value:e,low:i,high:s}=t.detail;null!=i||null!=s?(this._selectedLow=i,this._selectedHigh=s):this._selectedTemp=e}_onChanged(t){this._onChanging(t),this._scheduleCommit()}_showMoreInfo(){gt(this,"hass-more-info",{entityId:this._config.entity})}_colorMode(){const t=this._stateObj?.attributes;switch(t?.hvac_action){case"cooling":return"cool";case"heating":return"heat";case"drying":return"dry";case"fan":return"fan_only";default:return this._stateObj?.state??"off"}}render(){if(!this._config||!this.hass)return V``;const t=this._stateObj;if(!t)return V`<ha-card
      ...
      <ha-card style=${`--mt-active-color: ${Ct(r)}`}>
        ...
        <div class=${"body "+(o.wide?"wide":"stacked")}>
          <div class="dial-wrap" style=${wt(o.dialStyle)}>
            <mt-circular-dial
          ...
          ${this._config.features?.length?V`<div class="features" style=${wt(o.featureStyle)}>
    ...
    `}disconnectedCallback(){super.disconnectedCallback(),this._debounceTimer&&window.clearTimeout(this._debounceTimer),this._resizeObserver?.disconnect(),this._resizeObserver=void 0}};Kt.styles=[At,o`
      ha-card {
    ...
    `],t([pt({attribute:!1})],Kt.prototype,"hass",void 0),t([ut()],Kt.prototype,"_config",void 0),t([ut()],Kt.prototype,"_selectedTemp",void 0),t([ut()],Kt.prototype,"_selectedLow",void 0),t([ut()],Kt.prototype,"_selectedHigh",void 0),t([ut()],Kt.prototype,"_widthPx",void 0),Kt=t([ct(xt)],Kt);let Yt=class extends nt{constructor(){super(...arguments),this.value="icons"}_set(t){t!==this.value&&this.dispatchEvent(new CustomEvent("value-changed",{detail:{value:t},bubbles:!0,composed:!0}))}render(){return V`
      <div class="seg">
  ...
  `,t([pt({attribute:!1})],Xt.prototype,"hass",void 0),t([pt({attribute:!1})],Xt.prototype,"feature",void 0),Xt=t([ct("mt-input-select-editor")],Xt);let Zt=class extends nt{constructor(){super(...arguments),this.itemsKey="entities",this.showDisplay=!1}get _items(){return this.feature[this.itemsKey]??[]}_emit(t){this.dispatchEvent(new CustomEvent("feature-changed",{detail:{feature:{...this.feature,...t}},bubbles:!0,composed:!0}))}_setItems(t){this._emit({[this.itemsKey]:t})}_updateItem(t,e){const i=[...this._items],s={...i[t],...e};""===s.label&&delete s.label,""===s.icon&&delete s.icon,i[t]=s,this._setItems(i)}_addItem(){this._setItems([...this._items,{entity:""}])}_removeItem(t){const e=[...this._items];e.splice(t,1),this._setItems(e)}render(){const t=this.feature.display??"icons";return V`
      <div class="editor">
        <ha-textfield
          label="Row label (optional)"
          .value=${this.feature.label??""}
  ...
  `,t([pt({attribute:!1})],Zt.prototype,"hass",void 0),t([pt({attribute:!1})],Zt.prototype,"feature",void 0),t([pt()],Zt.prototype,"itemsKey",void 0),t([pt({type:Boolean})],Zt.prototype,"showDisplay",void 0),t([pt({attribute:!1})],Zt.prototype,"includeDomains",void 0),Zt=t([ct("mt-entity-list-editor")],Zt);const Jt=[{name:"entity",selector:{entity:{}}},{name:"name",selector:{text:{}}},{name:"icon",selector:{icon:{}}},{name:"compact",selector:{boolean:{}}},{name:"width",selector:{number:{min:60,max:400,step:10,mode:"slider",unit_of_measurement:"px"}}},{name:"tap_action",selector:{ui_action:{}}}];let Qt,te=class extends nt{constructor(){super(...arguments),this._computeLabel=t=>{switch(t.name){case"entity":return"Entity";case"name":return"Name (optional)";case"icon":return"Icon (optional)";case"compact":return"Compact (icon + value only)";case"width":return"Max width";case"tap_action":return"Tap action";default:return t.name}}}get _data(){return{entity:this.feature.entity,name:this.feature.name,icon:this.feature.icon,compact:this.feature.compact??!1,width:this.feature.width,tap_action:this.feature.tap_action}}_changed(t){const e=t.detail.value;this.dispatchEvent(new CustomEvent("feature-changed",{detail:{feature:{type:"entity-tile",entity:e.entity,name:e.name||void 0,icon:e.icon||void 0,compact:e.compact||void 0,width:e.width||void 0,tap_action:e.tap_action||void 0}},bubbles:!0,composed:!0}))}render(){return V`<ha-form
      ...
      <div class="editor">
        ...
        <div class="add">
          ...
          ${this._addOpen?V`<div class="add-menu">
                ${ie.map(t=>V`<button class="add-opt" @click=${()=>this._pickFeature(t.type)}>
                    ${t.label}
                  </button>`)}
              </div>`:B}
        </div>
    ...
    `}_renderFeatureEditor(t,e){const i=t=>this._featureChanged(e,t);let s;switch(t.type){case"climate-hvac-modes":case"climate-fan-modes":case"climate-swing-modes":{const e="climate-hvac-modes"===t.type?"hvac":"climate-fan-modes"===t.type?"fan":"swing";s=V`<mt-climate-feature-editor
        ...
        ></mt-entity-list-editor>`;break;case"entity-tile":s=V`<mt-entity-tile-editor
          ...
          .feature=${t}
          @feature-changed=${i}
        ></mt-entity-tile-editor>`;break;default:s=V`<p class="hint">No editor available.</p>`}return V`<div class="feature-editor">${s}</div>`}};re.styles=o`
    .editor {
      display: flex;
      flex-direction: column;
      gap: 16px;
  ...
  `,t([pt({attribute:!1})],re.prototype,"hass",void 0),t([ut()],re.prototype,"_config",void 0),t([ut()],re.prototype,"_editingIndex",void 0),t([ut()],re.prototype,"_addOpen",void 0),re=t([ct(kt)],re);var oe=Object.freeze({__proto__:null,get MaterialThermostatCardEditor(){return re}});export{Kt as MaterialThermostatCard};
