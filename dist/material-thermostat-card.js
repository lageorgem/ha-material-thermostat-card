...
`;let Jt=class extends ct{constructor(){super(...arguments),this.items=[],this.placeholder="",this.variant="pill",this.label="",this.forceOff=!1,this._open=!1,this._up=!1,this._alignRight=!1,this._onDocClick=t=>{this._open&&!t.composedPath().includes(this)&&(this._open=!1)},this._onOtherOpen=t=>{t.detail!==this&&(this._open=!1)}}connectedCallback(){super.connectedCallback(),document.addEventListener("click",this._onDocClick),document.addEventListener("mt-dropdown-open",this._onOtherOpen)}disconnectedCallback(){super.disconnectedCallback(),document.removeEventListener("click",this._onDocClick),document.removeEventListener("mt-dropdown-open",this._onOtherOpen)}get _active(){return this.items.find(t=>t.active)??this.items[0]}get _tileOn(){if(this.forceOff)return!1;const t=this.items.find(t=>t.active);return!!t&&!Dt(t.value)}_toggle(t){if(t.stopPropagation(),!this._open){const t=this.getBoundingClientRect();this._up=t.bottom>.55*window.innerHeight,this._alignRight=t.left+t.width/2>.5*window.innerWidth,document.dispatchEvent(new CustomEvent("mt-dropdown-open",{detail:this}))}this._open=!this._open}_select(t,e){t.stopPropagation(),this._open=!1,this.dispatchEvent(new CustomEvent("item-selected",{detail:{value:e}}))}render(){const t=this._active,e="tile"===this.variant?this._renderTile(t):this._renderPill(t);return V`${e}${this._open?this._renderMenu():W}`}_renderPill(t){return V`
    ...
    ></mt-selector-row>`:W}};t([mt({attribute:!1})],ae.prototype,"hass",void 0),t([mt({attribute:!1})],ae.prototype,"items",void 0),t([mt()],ae.prototype,"label",void 0),ae=t([ht("mt-button-list")],ae);const ne={sensor:"mdi:gauge",binary_sensor:"mdi:radiobox-marked",switch:"mdi:toggle-switch-variant",light:"mdi:lightbulb",fan:"mdi:fan",button:"mdi:gesture-tap-button",input_button:"mdi:gesture-tap-button",scene:"mdi:palette",script:"mdi:script-text"};let le=class extends ct{constructor(){super(...arguments),this.forceOff=!1,this._tap=()=>{this.config.entity&&function(t,e,i,s){const o=s??{action:"default"};switch(o.action){case"none":return;case"more-info":return void yt(t,"hass-more-info",{entityId:o.entity??i});case"toggle":return void e.callService("homeassistant","toggle",{entity_id:i});case"url":return void(o.url_path&&window.open(o.url_path));case"navigate":return void(o.navigation_path&&(window.history.pushState(null,"",o.navigation_path),yt(t,"location-changed",{replace:!1})));case"call-service":case"perform-action":{const t=o.perform_action??o.service;if(!t||!t.includes("."))return;const[i,s]=t.split(".");return void e.callService(i,s,o.data??o.service_data??{},o.target)}default:re(t,e,i)}}(this,this.hass,this.config.entity,this.config.tap_action)}}get _stateObj(){return this.hass?.states?.[this.config.entity]}get _tileOn(){if(this.forceOff)return!1;const t=this._stateObj;return!!t&&!Dt(t.state)}_secondary(){const t=this._stateObj;if(!t)return;const e=this.config.entity.split(".")[0];if("sensor"===e){const e=t.attributes.unit_of_measurement;return e?`${t.state} ${e}`:t.state}return["switch","light","fan","input_boolean","binary_sensor"].includes(e)?"on"===t.state?"On":"Off":["button","input_button","scene","script"].includes(e)?void 0:t.state}render(){if(!this.config?.entity)return W;const t=this._stateObj,e=this.config.entity.split(".")[0],i=this.config.name??t?.attributes.friendly_name??this.config.entity,s=this.config.icon??t?.attributes.icon??ne[e]??"mdi:eye",o=this._secondary(),r=this._tileOn,a=this.config.width,n=1===a,l=this.config.compact||"number"==typeof a&&a<=2;return n?V`
      ...
      `:l?V`
        <button
          class=${Ut({tile:!0,compact:!0,on:r})}
          @click=${this._tap}
          aria-label=${i}
          title=${i}
        >
      ...
      `:V`
      <button class=${Ut({tile:!0,on:r})} @click=${this._tap} aria-label=${i}>
  ...
  `,t([mt({attribute:!1})],xe.prototype,"hass",void 0),t([mt()],xe.prototype,"entityId",void 0),t([mt({attribute:!1})],xe.prototype,"feature",void 0),t([mt({type:Number})],xe.prototype,"span",void 0),t([mt({attribute:!1})],xe.prototype,"feelsLikeTemp",void 0),t([mt({attribute:!1})],xe.prototype,"feelsLikeHumidity",void 0),t([ft()],xe.prototype,"_comfortVisible",void 0),xe=t([ht("mt-feature-row")],xe),function(){const t=window;t.customIcons=t.customIcons||{},t.customIcons.mt||(t.customIcons.mt={getIcon:async t=>{const e=jt[t];if(!e)throw new Error(`Unknown mt icon: mt:${t}`);return e.secondary?{path:e.path,secondaryPath:e.secondary}:{path:e.path}},getIconList:async()=>Object.keys(jt).map(t=>({name:t,keywords:["ac","swing","vane","louver","climate","airflow",...t.split("-")]}))})}(),console.info("%c MATERIAL-THERMOSTAT-CARD %c v1.7.0 ","color: white; background: #6750a4; font-weight: 700;","color: #6750a4; background: white; font-weight: 700;"),window.customCards=window.customCards||[],window.customCards.push({type:Lt,name:"Material Thermostat Card",description:"A Material 3 Expressive thermostat card with customizable selectors and Nest/Google Home inspired UI.",preview:!0,documentationURL:"https://github.com/lageorgem/ha-material-thermostat-card",getEntitySuggestion:(t,e)=>"climate"===e.split(".")[0]?{config:{type:`custom:${Lt}`,entity:e}}:null});let $e=class extends ct{constructor(){super(...arguments),this._widthPx=0}static async getConfigElement(){return await Promise.resolve().then(function(){return Qe}),document.createElement(Mt)}static getStubConfig(t){const e=Object.keys(t.states).find(t=>t.startsWith("climate."))??"";return{type:`custom:${Lt}`,entity:e,features:[{type:"climate-hvac-modes"}]}}setConfig(t){if(!t.entity||"climate"!==t.entity.split(".")[0])throw new Error("You must specify a climate entity.");this._config=t}getCardSize(){return 7+(this._config?.features?.length??0)}get _stateObj(){return this.hass?.states?.[this._config?.entity]}_trackedEntityIds(){const t=new Set([this._config.entity]),e=this._config.feels_like;e?.temperature&&t.add(e.temperature),e?.humidity&&t.add(e.humidity);for(const e of this._config.features??[])"entity"in e&&e.entity&&t.add(e.entity),"entities"in e&&e.entities?.forEach(e=>t.add(e.entity)),"items"in e&&e.items?.forEach(e=>t.add(e.entity));return[...t]}_displayCurrent(t){const e=this._config.feels_like;if(!e?.show_as_current||!e.temperature||!e.humidity)return t;const i=parseFloat(String(this.hass?.states?.[e.temperature]?.state)),s=parseFloat(String(this.hass?.states?.[e.humidity]?.state));return isFinite(i)&&isFinite(s)?function(t,e){return function(t,e){const i=function(t){return 9*t/5+32}(t),s=Math.max(0,Math.min(100,e)),o=.5*(i+61+1.2*(i-68)+.094*s);if((o+i)/2<80)return Rt(o);let r=2.04901523*i-42.379+10.14333127*s-.22475541*i*s-.00683783*i*i-.05481717*s*s+.00122874*i*i*s+85282e-8*i*s*s-199e-8*i*i*s*s;return s<13&&i>=80&&i<=112?r-=(13-s)/4*Math.sqrt((17-Math.abs(i-95))/17):s>85&&i>=80&&i<=87&&(r+=(s-85)/10*((87-i)/5)),Rt(r)}(t,e)}(i,s):t}shouldUpdate(t){if(t.has("_config")||t.has("_selectedTemp")||t.has("_selectedLow")||t.has("_selectedHigh")||t.has("_widthPx"))return!0;if(!this._config)return!1;if(t.has("hass")){const e=t.get("hass");return!e||this._trackedEntityIds().some(t=>e.states[t]!==this.hass.states[t])}return!1}updated(t){if(t.has("hass")||t.has("_config")){const e=t.get("hass");!this._config?.theme||e&&e.themes===this.hass.themes&&!t.has("_config")||function(t,e,i,s){void 0===s&&(s=!1),t._themes||(t._themes={});var o=e.default_theme;("default"===i||i&&e.themes[i])&&(o=i);var r=bt({},t._themes);if("default"!==o){var a=e.themes[o];Object.keys(a).forEach(function(e){var i="--"+e;t._themes[i]="",r[i]=a[e]})}if(t.updateStyles?t.updateStyles(r):window.ShadyCSS&&window.ShadyCSS.styleSubtree(t,r),s){var n=document.querySelector("meta[name=theme-color]");if(n){n.hasAttribute("default-content")||n.setAttribute("default-content",n.getAttribute("content"));var l=r["--primary-color"]||n.getAttribute("default-content");n.setAttribute("content",l)}}}(this,this.hass.themes,this._config.theme)}if(t.has("hass")){const t=this._stateObj?.attributes;null!=this._selectedTemp&&t?.temperature===this._selectedTemp&&(this._selectedTemp=void 0),null!=this._selectedLow&&t?.target_temp_low===this._selectedLow&&(this._selectedLow=void 0),null!=this._selectedHigh&&t?.target_temp_high===this._selectedHigh&&(this._selectedHigh=void 0)}}_observeWidth(){this._resizeObserver||"undefined"==typeof ResizeObserver||(this._resizeObserver=new ResizeObserver(t=>{const e=t[0]?.contentRect.width??0,i=Math.max(0,e-32);Math.abs(i-this._widthPx)>=1&&(this._widthPx=i)}),this._resizeObserver.observe(this))}connectedCallback(){super.connectedCallback(),this._observeWidth()}_featureWidthPct(t){return"width"in t&&"number"==typeof t.width&&t.width>0?Math.max(10,Math.min(Ct,10*Math.round(t.width/10))):"entity-tile"===t.type?50:Ct}_featureSpan(t){return e=this._featureWidthPct(t),Math.max(1,Math.min(10,Math.round(e/10)));var e}_layout(){const t=this._config.features??[],e=this._widthPx,i=t.length?Math.max(...t.map(t=>this._featureWidthPct(t))):100,s=e*(100-i)/100;if(!(t.length>0&&i<100&&e>=560&&s>=240)){const t=Math.min(e,320);return{wide:!1,dialStyle:{marginBottom:`-${Math.round(.147*t)}px`},featureStyle:{},gridCols:10}}return{wide:!0,dialStyle:{flex:"1 1 auto"},featureStyle:{flex:`0 0 ${i}%`},gridCols:Math.max(1,i/10)}}get _isDual(){const t=this._stateObj?.attributes;return"heat_cool"===this._stateObj?.state&&null!=t?.target_temp_low&&null!=t?.target_temp_high}get _targetTemp(){return this._selectedTemp??this._stateObj?.attributes.temperature}get _targetLow(){return this._selectedLow??this._stateObj?.attributes.target_temp_low}get _targetHigh(){return this._selectedHigh??this._stateObj?.attributes.target_temp_high}_scheduleCommit(){this._debounceTimer&&window.clearTimeout(this._debounceTimer),this._debounceTimer=window.setTimeout(()=>{const t={entity_id:this._config.entity};this._isDual?(t.target_temp_low=this._targetLow,t.target_temp_high=this._targetHigh):t.temperature=this._targetTemp,this.hass.callService("climate","set_temperature",t)},600)}_onChanging(t){const{value:e,low:i,high:s}=t.detail;null!=i||null!=s?(this._selectedLow=i,this._selectedHigh=s):this._selectedTemp=e}_onChanged(t){this._onChanging(t),this._scheduleCommit()}_showMoreInfo(){yt(this,"hass-more-info",{entityId:this._config.entity})}_presetIcon(){const t=this._config.features?.find(t=>"climate-preset-modes"===t.type);if(!t)return;const e=this._stateObj?.attributes.preset_mode;if(!e||"none"===e||"off"===e)return;const i=t.options?.find(t=>t.value===e);return void 0!==i?.icon?i.icon||void 0:Zt(e)}_hvacColors(){const t=this._config.features?.find(t=>"climate-hvac-modes"===t.type),e={};for(const i of t?.options??[])i.color&&(e[i.value]=i.color);return e}_presetColor(){const t=this._config.features?.find(t=>"climate-preset-modes"===t.type);if(!t)return;const e=this._stateObj?.attributes.preset_mode;if(!e||"none"===e||"off"===e)return;const i=t.options?.find(t=>t.value===e);return i?.color??Pt(e)}_colorMode(){const t=this._stateObj?.attributes;switch(t?.hvac_action){case"cooling":return"cool";case"heating":return"heat";case"drying":return"dry";case"fan":return"fan_only";default:return this._stateObj?.state??"off"}}render(){if(!this._config||!this.hass)return V``;const t=this._stateObj;if(!t)return V`<ha-card
    ...
    `],t([mt({attribute:!1})],$e.prototype,"hass",void 0),t([ft()],$e.prototype,"_config",void 0),t([ft()],$e.prototype,"_selectedTemp",void 0),t([ft()],$e.prototype,"_selectedLow",void 0),t([ft()],$e.prototype,"_selectedHigh",void 0),t([ft()],$e.prototype,"_widthPx",void 0),$e=t([ht(Lt)],$e);let Ae=class extends ct{constructor(){super(...arguments),this.value="icons"}_set(t){t!==this.value&&this.dispatchEvent(new CustomEvent("value-changed",{detail:{value:t},bubbles:!0,composed:!0}))}render(){return V`
      <div class="seg">
  ...
  `,t([mt({type:Boolean,reflect:!0})],Le.prototype,"disabled",void 0),t([mt({type:Number})],Le.prototype,"value",void 0),t([mt({type:Number})],Le.prototype,"step",void 0),t([mt({type:Number})],Le.prototype,"min",void 0),t([mt({type:Number})],Le.prototype,"max",void 0),t([mt({type:Number})],Le.prototype,"range",void 0),t([mt({attribute:"tooltip-mode"})],Le.prototype,"tooltipMode",void 0),t([ft()],Le.prototype,"_pressed",void 0),t([ft()],Le.prototype,"_tooltipVisible",void 0),t([vt("#slider")],Le.prototype,"_slider",void 0),Le=t([ht("mt-grid-slider")],Le);let Me=class extends ct{constructor(){super(...arguments),this.default=Ct}_emit(t){this.dispatchEvent(new CustomEvent("width-changed",{detail:{value:t},bubbles:!0,composed:!0}))}_onChanged(t){const e=t.detail?.value;this._emit("number"==typeof e?e:void 0)}_reset(){null!=this.value&&this._emit(void 0)}render(){const t=null!=this.value,e=this.value??this.default;return V`
  ...
  `,t([mt({attribute:!1})],Oe.prototype,"hass",void 0),t([mt()],Oe.prototype,"value",void 0),t([mt()],Oe.prototype,"label",void 0),t([mt()],Oe.prototype,"defaultIcon",void 0),t([ft()],Oe.prototype,"_open",void 0),t([ft()],Oe.prototype,"_alignRight",void 0),t([ft()],Oe.prototype,"_icons",void 0),Oe=t([ht("mt-icon-field")],Oe);let ze=class extends ct{constructor(){super(...arguments),this.value="",this.label="",this.flatLeft=!1}_onInput(t){const e=t.target.value;this.dispatchEvent(new CustomEvent("value-changed",{detail:{value:e},bubbles:!0,composed:!0}))}render(){return V`<input
      type="text"
  ...
  `,t([mt({attribute:!1})],Ie.prototype,"hass",void 0),t([mt()],Ie.prototype,"entityId",void 0),t([mt()],Ie.prototype,"kind",void 0),t([mt({attribute:!1})],Ie.prototype,"feature",void 0),Ie=t([ht("mt-climate-feature-editor")],Ie);const Te={sensor:"mdi:gauge",binary_sensor:"mdi:radiobox-marked",switch:"mdi:toggle-switch-variant",light:"mdi:lightbulb",fan:"mdi:fan",input_boolean:"mdi:toggle-switch",input_select:"mdi:format-list-bulleted",button:"mdi:gesture-tap-button",input_button:"mdi:gesture-tap-button",scene:"mdi:palette",script:"mdi:script-text",climate:"mdi:thermostat"};let De=class extends ct{constructor(){super(...arguments),this.value="",this.label="Entity",this.allowCustom=!1,this._open=!1,this._onDocClick=t=>{this._open&&!t.composedPath().includes(this)&&(this._open=!1)}}connectedCallback(){super.connectedCallback(),document.addEventListener("click",this._onDocClick)}disconnectedCallback(){super.disconnectedCallback(),document.removeEventListener("click",this._onDocClick)}_iconFor(t,e){return e??Te[t.split(".")[0]]??"mdi:tag"}_items(){const t=this.hass?.states??{};return Object.keys(t).filter(t=>!this.includeDomains||this.includeDomains.includes(t.split(".")[0])).map(e=>{const i=t[e].attributes;return{value:e,primary:i.friendly_name??e,secondary:e,icon:this._iconFor(e,i.icon)}}).sort((t,e)=>t.primary.localeCompare(e.primary))}_selected(){if(!this.value)return;const t=this.hass?.states?.[this.value]?.attributes;return{name:t?.friendly_name??this.value,icon:this._iconFor(this.value,t?.icon)}}_toggle(t){t.stopPropagation(),this._open=!this._open}_onPick(t){this._open=!1,this.dispatchEvent(new CustomEvent("value-changed",{detail:{value:t.detail.value},bubbles:!0,composed:!0}))}render(){const t=this._selected();return V`
      <button
        type="button"
        class=${Ut({trigger:!0,open:this._open})}
        aria-haspopup="listbox"
  ...
  `,t([mt({attribute:!1})],De.prototype,"hass",void 0),t([mt()],De.prototype,"value",void 0),t([mt()],De.prototype,"label",void 0),t([mt({attribute:!1})],De.prototype,"includeDomains",void 0),t([mt({type:Boolean})],De.prototype,"allowCustom",void 0),t([ft()],De.prototype,"_open",void 0),De=t([ht("mt-entity-picker")],De);let He=class extends ct{_values(){return this.hass?.states?.[this.feature.entity]?.attributes?.options??[]}_orderedValues(){return Tt(this._values(),this.feature.order)}_moveOption(t){t.stopPropagation();const{oldIndex:e,newIndex:i}=t.detail,s=this._orderedValues(),[o]=s.splice(e,1);s.splice(i,0,o),this._emit({order:s})}_override(t){return this.feature.options?.find(e=>e.value===t)}_emit(t){this.dispatchEvent(new CustomEvent("feature-changed",{detail:{feature:{...this.feature,...t}},bubbles:!0,composed:!0}))}_setOverride(t,e){const i=[...this.feature.options??[]],s=i.findIndex(e=>e.value===t),o={...s>=0?i[s]:{value:t},...e};""===o.label&&delete o.label,void 0===o.icon&&delete o.icon,o.hide||delete o.hide,o.color||delete o.color;const r=void 0!==o.label||void 0!==o.icon||!!o.hide||!!o.color;s>=0?r?i[s]=o:i.splice(s,1):r&&i.push(o),this._emit({options:i})}render(){const t=this._values(),e=this.feature.display??"icons";return V`
      <div class="editor">
        <mt-entity-picker
          .hass=${this.hass}
  ...
  `,t([mt({attribute:!1})],He.prototype,"hass",void 0),t([mt({attribute:!1})],He.prototype,"feature",void 0),He=t([ht("mt-input-select-editor")],He);let Re=class extends ct{constructor(){super(...arguments),this.itemsKey="entities",this.showDisplay=!1}get _items(){return this.feature[this.itemsKey]??[]}_emit(t){this.dispatchEvent(new CustomEvent("feature-changed",{detail:{feature:{...this.feature,...t}},bubbles:!0,composed:!0}))}_setItems(t){this._emit({[this.itemsKey]:t})}_updateItem(t,e){const i=[...this._items],s={...i[t],...e};""===s.label&&delete s.label,void 0===s.icon&&delete s.icon,s.color||delete s.color,i[t]=s,this._setItems(i)}_addItem(){this._setItems([...this._items,{entity:""}])}_moveItem(t){t.stopPropagation();const{oldIndex:e,newIndex:i}=t.detail,s=[...this._items],[o]=s.splice(e,1);s.splice(i,0,o),this._setItems(s)}_removeItem(t){const e=[...this._items];e.splice(t,1),this._setItems(e)}render(){const t=this.feature.display??"icons",e=this.showDisplay&&"tile"===t;return V`
      <div class="editor">
        <mt-text-field
          label="Row label (optional)"
          .value=${this.feature.label??""}
  ...
  `,t([mt({attribute:!1})],Ve.prototype,"hass",void 0),t([mt({attribute:!1})],Ve.prototype,"feature",void 0),t([mt({type:Boolean})],Ve.prototype,"feelsLikeConfigured",void 0),Ve=t([ht("mt-comfort-editor")],Ve);const qe=[{name:"entity",selector:{entity:{domain:"climate"}}},{name:"name",selector:{text:{}}},{name:"theme",selector:{theme:{}}},{name:"show_current_as_primary",selector:{boolean:{}}}],Be=[{name:"temperature",selector:{entity:{domain:"sensor"}}},{name:"humidity",selector:{entity:{domain:"sensor"}}},{name:"show_as_current",selector:{boolean:{}}}],We=[{type:"climate-hvac-modes",label:"Climate HVAC modes"},{type:"climate-fan-modes",label:"Climate fan modes"},{type:"climate-swing-modes",label:"Climate swing modes"},{type:"climate-preset-modes",label:"Climate preset modes"},{type:"comfort",label:"Comfort & time to comfortable"},{type:"input-select",label:"Input select"},{type:"switch-group",label:"Switch group"},{type:"switch-list",label:"Switch list"},{type:"button-list",label:"Button list"},{type:"entity-tile",label:"Entity tile"},{type:"sensor-list",label:"Sensor list"}],Ke={"climate-hvac-modes":"hvac_modes","climate-fan-modes":"fan_modes","climate-swing-modes":"swing_modes","climate-preset-modes":"preset_modes"},Xe=new Set(["comfort"]);function Ye(t){switch(t){case"input-select":case"entity-tile":return{type:t,entity:""};case"switch-group":case"switch-list":return{type:t,entities:[]};case"button-list":case"sensor-list":return{type:t,items:[]};case"comfort":return{type:t,show_target_eta:!1};default:return{type:t}}}const Ge={"climate-hvac-modes":"Climate HVAC modes","climate-fan-modes":"Climate fan modes","climate-swing-modes":"Climate swing modes","climate-preset-modes":"Climate preset modes",comfort:"Comfort & time to comfortable","input-select":"Input select","switch-group":"Switch group","switch-list":"Switch list","button-list":"Button list","entity-tile":"Entity tile","sensor-list":"Sensor list"};let Je=class extends ct{constructor(){super(...arguments),this._editingIndex=null,this._addOpen=!1,this._computeLabel=t=>{switch(t.name){case"entity":return"Climate entity (required)";case"name":return"Name";case"theme":return"Theme";case"show_current_as_primary":return"Show current temperature as primary information";case"temperature":return"Temperature sensor";case"humidity":return"Humidity sensor";case"show_as_current":return"Show feels-like as the current temperature";default:return t.name}}}connectedCallback(){super.connectedCallback(),(Ue||(Ue=(async()=>{if(customElements.get("ha-form")&&customElements.get("ha-entity-picker")&&customElements.get("ha-icon-picker"))return;const t=window.loadCardHelpers;if(t)try{const e=await t(),i=await e.createCardElement({type:"entities",entities:[]}),s=i?.constructor;s?.getConfigElement&&await s.getConfigElement()}catch{}})(),Ue)).then(()=>this.requestUpdate())}setConfig(t){this._config=t}get _baseData(){return{entity:this._config.entity,name:this._config.name,theme:this._config.theme,show_current_as_primary:this._config.show_current_as_primary??!1}}get _feelsLikeData(){const t=this._config.feels_like??{};return{temperature:t.temperature,humidity:t.humidity,show_as_current:t.show_as_current??!1}}_emit(t){this._config=t,yt(this,"config-changed",{config:t})}_baseChanged(t){const e=t.detail.value,i={...this._config,entity:e.entity,name:e.name||void 0,theme:e.theme||void 0,show_current_as_primary:e.show_current_as_primary||void 0};this._emit(i)}_feelsLikeChanged(t){const e=t.detail.value,i={temperature:e.temperature||void 0,humidity:e.humidity||void 0,show_as_current:e.show_as_current||void 0},s=!i.temperature&&!i.humidity&&!i.show_as_current;this._emit({...this._config,feels_like:s?void 0:i})}get _features(){return this._config.features??[]}_addableFeatures(){const t=this.hass?.states?.[this._config.entity]?.attributes??{},e=new Set(this._features.map(t=>t.type));return We.filter(({type:i})=>{if(Xe.has(i))return!e.has(i);const s=Ke[i];return!s||!e.has(i)&&Array.isArray(t[s])&&t[s].length>0})}_setFeatures(t){this._emit({...this._config,features:t})}_pickFeature(t){this._addOpen=!1;const e=[...this._features,Ye(t)];this._editingIndex=e.length-1,this._setFeatures(e)}_removeFeature(t){const e=[...this._features];e.splice(t,1),this._editingIndex=null,this._setFeatures(e)}_moveFeature(t){const{oldIndex:e,newIndex:i}=t.detail,s=[...this._features],[o]=s.splice(e,1);s.splice(i,0,o),this._editingIndex=null,this._setFeatures(s)}_featureChanged(t,e){const i=[...this._features];i[t]=e.detail.feature,this._setFeatures(i)}render(){return this._config&&this.hass?V`
      <div class="editor">
        <ha-form
          .hass=${this.hass}
          .data=${this._baseData}
    ...
    `:V``}_renderFeatureRow(t,e){const i=this._editingIndex===e;return V`
      <div class="feature">
        <div class="feature-head">
          <div class="handle"><ha-icon icon="mdi:drag"></ha-icon></div>
          <div class="feature-title">${Ge[t.type]??t.type}</div>
          <button
            class="icon-btn"
    ...
    `}_renderFeatureEditor(t,e){const i=t=>this._featureChanged(e,t);let s;switch(t.type){case"climate-hvac-modes":case"climate-fan-modes":case"climate-swing-modes":case"climate-preset-modes":{const e="climate-hvac-modes"===t.type?"hvac":"climate-fan-modes"===t.type?"fan":"climate-preset-modes"===t.type?"preset":"swing";s=V`<mt-climate-feature-editor
        ...
        ></mt-entity-list-editor>`;break;case"comfort":s=V`<mt-comfort-editor
          ...
          @feature-changed=${i}
        ></mt-comfort-editor>`;break;default:s=V`<p class="hint">No editor available.</p>`}return V`<div class="feature-editor">${s}</div>`}};Je.styles=a`
    .editor {
      display: flex;
      flex-direction: column;
      gap: 16px;
  ...
  `,t([mt({attribute:!1})],Je.prototype,"hass",void 0),t([ft()],Je.prototype,"_config",void 0),t([ft()],Je.prototype,"_editingIndex",void 0),t([ft()],Je.prototype,"_addOpen",void 0),Je=t([ht(Mt)],Je);var Qe=Object.freeze({__proto__:null,get MaterialThermostatCardEditor(){return Je}});export{$e as MaterialThermostatCard};
